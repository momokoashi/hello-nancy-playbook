...
const EVENTS = {
  ...
  events: [
    ...
    // ===== JUNE 4: Lem Play Big Launch =====
    {
      ...
      endDate: "2026-06-04",
      preOrderStartDate: "2026-05-21",
      summary: "Big launch — Lem Play, Bluetooth-enabled couple toy. Kicks off Pair Play Sale. Final day of Splashy Sale. Pre-order opens May 21 (T-2w).",
    ...
    // Jelly Pudding launch (inside Out of Office)
    {
      ...
      endDate: "2026-07-30",
      preOrderStartDate: "2026-07-16",
      summary: "Jelly Pudding launches inside Vacay Sale. Jelly = summer-feeling product, fits the season. Pre-order opens Jul 16 (T-2w).",
    ...
    // Poison Ivy launch (inside Out of Office) — "cheeky" removed from name
    {
      ...
      endDate: "2026-08-04",
      preOrderStartDate: "2026-07-21",
      summary: "Tongue toy launch inside Vacay Sale. Pre-order opens Jul 21 (T-2w).",
    ...
    // ===== AUG 31: Tennis Launch + Smash Sale (extended through Sep 22) =====
    {
      ...
      endDate: "2026-08-31",
      preOrderStartDate: "2026-08-17",
      summary: "Sunday launch (exception to Tue-Thu rule). Times to start of US Open week. Kicks off Smash Sale. Pre-order opens Aug 17 (T-2w).",
    ...
    // Lem Pro Play — MOVED to Sep 10 (Thu) inside Smash Sale
    {
      ...
      endDate: "2026-09-10",
      preOrderStartDate: "2026-08-27",
      summary: "Premium Bluetooth Lem upgrade. MOVED to Sep 10 inside Smash Sale. Pre-order opens Aug 27 (T-2w).",
    ...
    // Flower 2.0 — MOVED to Sep 24 (Thu) inside Reawakening Sale
    {
      ...
      endDate: "2026-09-24",
      preOrderStartDate: "2026-09-10",
      summary: "Premium upgrade with new tech. MOVED to Sep 24 inside Reawakening Sale. Pre-order opens Sep 10 (T-2w) — note: same day as Lem Pro Play launch.",
    ...
    },
    {
      ...
      startDate: "2026-10-08",
      endDate: "2026-10-08",
      preOrderStartDate: "2026-09-24",
      summary: "Halloween-tied launch. Kicks off Halloween Sale. Pre-order opens Sep 24 (T-2w) — note: same day as Flower 2.0 launch.",
    ...
    },
    {
      ...
      endDate: "2026-11-17",
      preOrderStartDate: "2026-11-03",
      summary: "Inside BFCM Sale. Featured product. Concept TBD: Tannenbaum / Mistletoe / Pine / Star. Pre-order opens Nov 3 (T-2w) — same day Early Black Friday Sale starts.",
